package com.dais.rongcloud;



import com.dais.rongcloud.messages.TxtMessage;
import com.dais.rongcloud.messages.VoiceMessage;
import com.dais.rongcloud.models.*;
...
public class Example {
	...
	public static void main(String[] args) throws Exception {
		String appKey = "pvxdm17jpidjr";//替换成您的appkey
		String appSecret = "dFBfD9HDJ4";//替换成匹配上面key的secret
...
//		// 获取 Token 方法
//		TokenResult userGetTokenResult = rongCloud.user.getToken("1001", "xxp", "http://www.rongcloud.cn/images/logo.png");
//		System.out.println("getToken:  " + userGetTokenResult.toString());
//////
////		// 刷新用户信息方法
//		CodeSuccessResult userRefreshResult = rongCloud.user.refresh("1001", "xxp", "http://www.rongcloud.cn/images/logo.png");
