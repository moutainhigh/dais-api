...
<div class="layui-layout layui-layout-admin">
        ...
        <div class="layui-body">
            ...
            <span class="layui-breadcrumb" style="visibility: visible;">
              ...
              <a >DAIS账户<span class="layui-box">&gt;</span></a>
              <a><cite>账户资产</cite></a>
            </span>
...
<div id="editform" style="display: none; position:relative;">
    ...
    <div style="display: none;position: fixed;width: 318px; height: 140px; background: #e2e2e2;top: 32%;left: 27%;" id="showMsgDiv">
        ...
        <div style="position: fixed;top: 69%;left: 50%;"><button class="layui-btn layui-btn-small" onclick="closeMsgDailog()"><i class="layui-icon">确定</i></button></div>
    </div>
</div>
...
<script type="text/javascript">
    ...
    function getSysParamInfo(data){
        ...
        $.each(data,function(v,o){
            ...
            s+='<td>'+formatDate(o.update_time)+'</td>';
            s += '<c:if test="${user_info.roleid < 3}"><td><button class="layui-btn layui-btn-small" onclick="edit(this,1)"><i class="layui-icon">修改资金' +
                    '</i></button></td></c:if></tr>';
        });
        if(data.length>0){
            $("#pageDiv").show();
