...
<script type="text/javascript">
    ...
    function getDataPageInfo(){
        $.ajax({
            type:"post",
            async:false,
            url:"/captualoperation/getCaptualoperationWithdrawlist",
    ...
    function getSysParamInfo(data){
        ...
        $.each(data,function(v,o){
           ...
           /* s+='<td><button onclick="edit(this)" class="layui-btn layui-btn-small"><i class="layui-icon">审核</i></button></td></tr>';*/
            s += '<c:if test="${user_info.roleid < 3}"><td><div class="layui-btn-group"> <button class="layui-btn layui-btn-small" onclick="opration(this,1)"><i class="layui-icon">锁定' +
