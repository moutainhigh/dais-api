...
public class ValidateCode {
	 ...
	 * @return 验证码字符串
	 */
	public static String[] generateFormulaCode() {
		...
		int result = x + y;
		String arr[] = { code.toString(), result + "" };
		return arr;
	}
	 ...
	 * @return 图片缓存对象
	 */
	public static BufferedImage generateImageCode(int type, int length, String exChars, int width, int height, int interLine, boolean randomLocation, Color backColor,
